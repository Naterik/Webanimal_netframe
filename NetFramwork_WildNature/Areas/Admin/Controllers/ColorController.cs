...
namespace NetFramwork_WildNature.Areas.Admin.Controllers
{
    public class ColorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Code,Name,ColorSpecific")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Code,Name,ColorSpecific")] Color color)
        {
            if (ModelState.IsValid)
            {
